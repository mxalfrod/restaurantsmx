...
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 41.2;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -77.8;
...
var _hearth = __webpack_require__(11);

var _hearth2 = _interopRequireDefault(_hearth);
...
heartForms.on('submit', _hearth2.default);
